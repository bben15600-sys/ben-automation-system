...
PEPPERS: list[Pepper] = [
    ...
    Pepper(3,  "אנברו ריפר אדום",       "Carolina Reaper (Red)",      "Carolina_Reaper",              "Carolina Reaper red ripe pods", "red",       "Capsicum chinense",              "~1.6M–2.2M SHU"),
    ...
    Pepper(9,  "קרולינה ריפר אדום",     "Carolina Reaper (Red)",      "Carolina_Reaper",              "Carolina Reaper pepper",        "red",       "Capsicum chinense",              "~1.6M–2.2M SHU"),
    Pepper(10, "גוליקה בהוט צהוב",      "Yellow Bhut Jolokia",        "Bhut_jolokia",                 "Yellow Bhut Jolokia",           "yellow",    "Capsicum chinense × frutescens", "~800K–1M SHU"),
    Pepper(11, "סקורפיו ריפר אדום",     "Trinidad Scorpion (Red)",    "Trinidad_Scorpion_pepper",     "Trinidad Scorpion pepper red",  "red",       "Capsicum chinense",              "~1.2M–2M SHU"),
    Pepper(12, "צ׳רי בומב אדום",        "Cherry Bomb (F1)",           "Cherry_pepper",                "Cherry Bomb pepper",            "red",       "Capsicum annuum",                "2.5K–5K SHU"),
    Pepper(13, "גוליקה בהוט סגול",      "Purple Bhut Jolokia",        "Bhut_jolokia",                 "Purple Bhut Jolokia",           "purple",    "Capsicum chinense",              "~800K–1M SHU"),
    Pepper(14, "ציפור תאילנדי",         "Thai Bird's Eye",            "Bird%27s_eye_chili",           "Thai bird's eye chili",         "red",       "Capsicum annuum",                "50K–100K SHU"),
    Pepper(15, "גמיקאן ילו צהוב",       "Yellow Scotch Bonnet",       "Scotch_bonnet",                "Yellow Scotch Bonnet pepper",   "yellow",    "Capsicum chinense",              "100K–350K SHU"),
    Pepper(16, "צ׳ילי תאילנדי ארוך",    "Thai Long / Spur Chili",     "Thai_pepper",                  "Thai long spur chili pepper",   "red",       "Capsicum annuum",                "15K–50K SHU"),
    Pepper(17, "עקרב לבן",              "White Trinidad Scorpion",    "Trinidad_Scorpion_pepper",     "White Trinidad Scorpion",       "white",     "Capsicum chinense",              "~1M+ SHU"),
    Pepper(18, "דובדבן אדום",           "Mexican Cherry / Pimiento",  "Pimiento",                     "Pimiento cherry pepper",        "red",       "Capsicum annuum",                "100–500 SHU"),
    Pepper(19, "קריולה סלה",            "Criolla Sella (Aji Crystal)","Capsicum_baccatum",            "Criolla Sella aji",             "yellow",    "Capsicum baccatum",              "~30K SHU"),
    Pepper(20, "אנברו מנורת לילה",      "Aji Lantern / Bishop's Crown","Bishop%27s_crown",            "Aji Lantern Bishop's crown",    "orange",    "Capsicum baccatum",              "5K–30K SHU"),
]
