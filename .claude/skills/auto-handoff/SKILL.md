---
name: auto-handoff
description: "Auto-save a comprehensive session handoff every 20 turns and at session end. Produces a self-contained transfer document covering goal, history, decisions, files, plan, and open questions — sized so a fresh session can resume with zero context loss. Triggered by Stop/SessionEnd hooks or invoked manually."
allowed-tools:
  - Read
  - Write
  - Edit
...
evidence: "First use 2026-05-01 — addresses long-session context loss."
---
